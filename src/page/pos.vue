...
<script>
  ...
  export default {
    ...
    created() {
      this.type0Goods = this.allData[0];
      this.type1Goods = this.allData[1];
      this.type2Goods = this.allData[2];
      this.type3Goods = this.allData[3];
      let index=parseInt(Math.random()*4);
      this.oftenGoods=this.allData[index];
    },
    methods: {
      addOrderList(goods) {
        let flag = false;
